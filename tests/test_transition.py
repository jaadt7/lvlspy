...
def test_default_rates_reject_nonpositive_energy_gaps(
    ...
    """Nonpositive energy gaps are invalid for the default rate laws."""
...
def test_default_rates_reject_negative_temperature():
    """Default rates reject temperatures below zero."""
...
def test_custom_rates_control_their_temperature_domain():
    """Custom callbacks are free to define their own domain."""
...
def test_transition_rejects_invalid_einstein_a(einstein_a):
    """Invalid Einstein A coefficients are rejected at construction."""
...
def test_transition_update_rejects_invalid_einstein_a():
    """Invalid Einstein A coefficients are rejected during updates."""
